...
<div id="sidebar">
    ...
    <ul style="list-style:none;padding:0 18px;">
        <li><a href="/user_home" style="color:#fff;display:block;padding:7px 0;">🏠 我的主页</a></li>
        <li><a href="/etc/settings" style="color:#fff;display:block;padding:7px 0;">⚙️ 设置</a></li>
        <li><a href="/etc/help" style="color:#fff;display:block;padding:7px 0;">❓ 帮助</a></li>
        <li><a href="/etc/logout" style="color:#fff;display:block;padding:7px 0;">🚪 登出</a></li>
    </ul>
