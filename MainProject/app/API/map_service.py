        ...
        <body>
            <div class="map-app">
                ...
                <div class="history-panel">
                    <h6>搜索历史 <small style="color:#6c757d">(点击可恢复位置)</small></h6>
            ...
            <script>
                ...
                function getHistoryStorageKey() {{
                    // 使用URL路径和查询参数来构建唯一标识
                    // 提取pathname部分和主要的query参数（忽略临时参数）
                ...
                function updateHistoryList() {{
                    ...
                    if (history.length === 0) {{
                        historyList.innerHTML = '<div style="color:#6c757d">暂无历史记录</div>';
                        return;
                    }}
                    ...
                    history.forEach(item => {{
                        ...
                        historyItem.innerHTML = `
                            <span title="${{item.time}}">${{item.name}}</span>
                            <small style="color:#6c757d">(${{item.lng}}, ${{item.lat}})</small>
                        `;
